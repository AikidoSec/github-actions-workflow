...
- `post-sast-review-comments`: Let Aikido post review comments on the PR (when in PR context) of SAST scan findings and a link to the Aikido platform. Value can be one of "on", "off".
